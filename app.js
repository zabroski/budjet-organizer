...
const incomeE1 = document.querySelector("#income-tracker");
const expenseE1 = document.querySelector("#expense-tracker");
...
function updateUI() {
    ...
    //updating the UI 
    balanceE1.innerHTML = `<p>${sign}</p><p>${balance}</p>`
    incomeTotalE1.innerHTML = `<p>$</p><p>${income}</p>`
    outcomeTotalE1.innerHTML = `<p>$</p><p>${outcome}</p>`
